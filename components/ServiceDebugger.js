            ...
            {service.hasWorker && service.worker && (
              <View style={styles.workerContainer}>
                ...
                <View style={styles.infoRow}>
                  ...
                  <Text style={styles.infoValue}>{service.worker.full_name || 'Not set'}</Text>
                </View>
                
                <View style={styles.infoRow}>
                  <Text style={styles.infoLabel}>Worker Full Name:</Text>
                  <Text style={styles.infoValue}>{service.worker.worker_full_name || 'Not set'}</Text>
                </View>
                
                <View style={styles.infoRow}>
                  <Text style={styles.infoLabel}>Raw Worker Data:</Text>
                  <Text style={[styles.infoValue, {fontSize: 10}]}>{JSON.stringify(service.worker, null, 2)}</Text>
                </View>
