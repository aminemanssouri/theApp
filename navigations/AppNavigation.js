      ...
      >
        {
          ...
          !user ? (
            <>
              ...
              <Stack.Screen name="CreateNewPIN" component={CreateNewPIN} options={getTransitionConfig('CreateNewPIN')} />
              <Stack.Screen name="Fingerprint" component={Fingerprint} options={getTransitionConfig('Fingerprint')} />
            </>
          ) : (
            <>
              <Stack.Screen 
